...
resource "aws_security_group" "sp-private-metabase-sg" {
  vpc_id      = aws_vpc.sp-vpc.id
  name        = "sp-private-metabase-sg"
  description = "Allows SSH access to developers"
...
resource "aws_security_group" "sp-public-frontend-alb-sg" {
  vpc_id      = aws_vpc.sp-vpc.id
  name        = "sp-public-frontend-alb-sg"
  description = "Allows Ports for Access"
...
resource "aws_security_group" "sp-public-backend-alb-sg" {
  vpc_id      = aws_vpc.sp-vpc.id
  name        = "sp-public-backend-alb-sg"
  description = "Allows Ports for Access"
...
resource "aws_security_group" "sp-public-metabase-alb-sg" {
  vpc_id      = aws_vpc.sp-vpc.id
  name        = "sp-public-metabase-alb-sg"
  description = "Allows Ports for Access"
